_smac_validate()
{
	...
	case "${prev}" in
	--configuration-list|--help-default-file|--validation-defaults-file|--scenario-file|--search-subspace-file|--run-hashcode-file|--tae-default-file)
		 _filedir
		return 0
		;;
	--prepost-exec-dir)
	...
	--validation-rounding-mode)
		...
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	--auto-increment-tunertime|--includeDefaultAsFirstRandom|--trajectory-use-tunertime-if-no-walltime|--use-scenario-outdir|--validate-test-instances|--wait-for-persistent-run-completion|--check-instances-exist|--use-instances|--use-cpu-time-in-tunertime|--algo-deterministic|--deterministic|--abort-on-crash|--abort-on-first-run-crash|--bound-runs|--check-for-unclean-shutdown|--check-for-unique-runconfigs|--check-for-unique-runconfigs-exception|--check-result-order-consistent|--check-sat-consistency|--checkSATConsistency|--check-sat-consistency-exception|--exception-on-prepost-command|--kill-run-exceeding-captime|--leak-memory|--log-requests-responses|--log-requests-responses-rc-only|--log-requests-responses-rc|--observer-walltime-if-no-runtime|--prepost-log-output|--skip-outstanding-eval-tae|--synchronize-observers|--track-scheduled-runs|--verify-sat|--verify-SAT|--verifySAT|--tae-transform|--tae-transform-valid-values-only|--save-state-file|--validate-all|--validate-by-wallclock-time|--validate-only-last-incumbent|--validation-headers)
		answers="true  false"
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	*)
		answers="--abort-on-crash --abort-on-first-run-crash --algo --algo-cutoff-length --algo-cutoff-time --algo-deterministic --algo-exec --algo-exec-dir --auto-increment-tunertime --bound-runs --check-for-unclean-shutdown --check-for-unique-runconfigs --check-for-unique-runconfigs-exception --check-instances-exist --check-result-order-consistent --check-sat-consistency --check-sat-consistency-exception --checkSATConsistency --configuration --configuration-list --console-log-level --continous-neighbours --continuous-neighbors --cores --cputime-limit --cputime_limit --cutoff-time --cutoff_length --cutoff_time --deterministic --empirical-performance --exception-on-prepost-command --exec-dir --execdir --experiment-dir --feature-file --feature_file --help --help-default-file --help-level --includeDefaultAsFirstRandom --instance-dir --instance-file --instance-regex --instance-suffix --instance_file --instance_seed_file --instances --inter-instance-obj --inter-obj --inter_instance_obj --intra-instance-obj --intra-obj --intra_instance_obj --invalid-scenario-reason --iteration-limit --kill-run-exceeding-captime --kill-run-exceeding-captime-factor --kill-runs-on-file-delete --leak-memory --leak-memory-amount --log-level --log-requests-responses --log-requests-responses-rc --log-requests-responses-rc-only --max-norun-challenge-limit --max-timestamp --min-timestamp --mult-factor --num-run --num-seeds-per-test-instance --num-test-instances --num-validation-runs --numrun --observer-walltime-delay --observer-walltime-if-no-runtime --observer-walltime-scale --outdir --output-dir --output-file-suffix --overall-obj --overall_obj --param-file --paramfile --pcs-file --post-scenario-command --post_cmd --pre-scenario-command --pre_cmd --prepost-exec-dir --prepost-log-output --random --random-configurations --retry-crashed-count --run-hashcode-file --run-obj --run-objective --run_obj --runcount-limit --runcount_limit --runtime-limit --save-state-file --scenario-file --search-subspace --search-subspace-file --seed --seed-offset --show-hidden --skip-outstanding-eval-tae --synchronize-observers --tae --tae-default-file --tae-transform --tae-transform-SAT-quality --tae-transform-SAT-runtime --tae-transform-TIMEOUT-quality --tae-transform-TIMEOUT-runtime --tae-transform-UNSAT-quality --tae-transform-UNSAT-runtime --tae-transform-other-quality --tae-transform-other-runtime --tae-transform-valid-values-only --tae-warn-if-no-response-from-tae --target-run-cputime-limit --target_run_cputime_limit --terminate-on-delete --test-instance-dir --test-instance-file --test-instance-regex --test-instance-suffix --test-instances --test_instance_file --test_instance_seed_file --track-scheduled-runs --track-scheduled-runs-resolution --trajectory-file --trajectory-files --trajectory-use-tunertime-if-no-walltime --tuner-overhead-time --tuner-timeout --tunertime-limit --use-cpu-time-in-tunertime --use-instances --use-scenario-outdir --validate-all --validate-by-wallclock-time --validate-only-if-tunertime-reached --validate-only-if-walltime-reached --validate-only-last-incumbent --validate-test-instances --validation-defaults-file --validation-headers --validation-rounding-mode --validation-tunertime --verify-SAT --verify-sat --verifySAT --version --wait-for-persistent-run-completion --wall-time --wallclock-limit --wallclock_limit "
		if [[ ${cur} == -* ]] ; then
        		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
	        	return 0
    		fi
...
_sat_check()
{
	...
	--log-level|--console-log-level)
		...
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	--overwrite-output-file|--use-test-set-instances|--check-instances-exist|--use-instances|--use-cpu-time-in-tunertime|--algo-deterministic|--deterministic|--abort-on-crash|--abort-on-first-run-crash|--bound-runs|--check-for-unclean-shutdown|--check-for-unique-runconfigs|--check-for-unique-runconfigs-exception|--check-result-order-consistent|--check-sat-consistency|--checkSATConsistency|--check-sat-consistency-exception|--exception-on-prepost-command|--kill-run-exceeding-captime|--leak-memory|--log-requests-responses|--log-requests-responses-rc-only|--log-requests-responses-rc|--observer-walltime-if-no-runtime|--prepost-log-output|--skip-outstanding-eval-tae|--synchronize-observers|--track-scheduled-runs|--verify-sat|--verify-SAT|--verifySAT|--tae-transform|--tae-transform-valid-values-only)
		answers="true  false"
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	*)
		answers="--abort-on-crash --abort-on-first-run-crash --algo --algo-cutoff-length --algo-cutoff-time --algo-deterministic --algo-exec --algo-exec-dir --bound-runs --check-for-unclean-shutdown --check-for-unique-runconfigs --check-for-unique-runconfigs-exception --check-instances-exist --check-result-order-consistent --check-sat-consistency --check-sat-consistency-exception --checkSATConsistency --config --config-seed --console-log-level --continous-neighbours --continuous-neighbors --cores --cputime-limit --cputime_limit --cutoff-time --cutoff_length --cutoff_time --deterministic --exception-on-prepost-command --exec-dir --execdir --feature-file --feature_file --help --help-default-file --help-level --instance-dir --instance-file --instance-regex --instance-suffix --instance_file --instance_seed_file --instances --inter-instance-obj --inter-obj --inter_instance_obj --intra-instance-obj --intra-obj --intra_instance_obj --invalid-scenario-reason --iteration-limit --kill-run-exceeding-captime --kill-run-exceeding-captime-factor --kill-runs-on-file-delete --leak-memory --leak-memory-amount --log-level --log-requests-responses --log-requests-responses-rc --log-requests-responses-rc-only --max-norun-challenge-limit --observer-walltime-delay --observer-walltime-if-no-runtime --observer-walltime-scale --outdir --output-dir --output-file --overall-obj --overall_obj --overwrite-output-file --param-file --paramfile --pcs-file --post-scenario-command --post_cmd --pre-scenario-command --pre_cmd --prepost-exec-dir --prepost-log-output --retry-crashed-count --run-hashcode-file --run-obj --run-objective --run_obj --runcount-limit --runcount_limit --runtime-limit --scenario-file --search-subspace --search-subspace-file --seed --show-hidden --skip-outstanding-eval-tae --synchronize-observers --tae --tae-default-file --tae-transform --tae-transform-SAT-quality --tae-transform-SAT-runtime --tae-transform-TIMEOUT-quality --tae-transform-TIMEOUT-runtime --tae-transform-UNSAT-quality --tae-transform-UNSAT-runtime --tae-transform-other-quality --tae-transform-other-runtime --tae-transform-valid-values-only --tae-warn-if-no-response-from-tae --taeRunnerDefaultsFile --target-run-cputime-limit --target_run_cputime_limit --terminate-on-delete --test-instance-dir --test-instance-file --test-instance-regex --test-instance-suffix --test-instances --test_instance_file --test_instance_seed_file --track-scheduled-runs --track-scheduled-runs-resolution --tuner-timeout --tunertime-limit --use-cpu-time-in-tunertime --use-instances --use-test-set-instances --verify-SAT --verify-sat --verifySAT --version --wallclock-limit --wallclock_limit "
		if [[ ${cur} == -* ]] ; then
        		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
	        	return 0
    		fi
...
_state_merge()
{
	...
	--log-level|--console-log-level)
		...
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	--mask-censored-data-as-kappa-max|--mask-inactive-conditional-parameters-as-default-value|--repair-smac-invariant|--repair|--replace-seeds|--treat-censored-data-as-uncensored|--check-instances-exist|--use-instances|--use-cpu-time-in-tunertime|--algo-deterministic|--deterministic|--abort-on-crash|--abort-on-first-run-crash|--bound-runs|--check-for-unclean-shutdown|--check-for-unique-runconfigs|--check-for-unique-runconfigs-exception|--check-result-order-consistent|--check-sat-consistency|--checkSATConsistency|--check-sat-consistency-exception|--exception-on-prepost-command|--kill-run-exceeding-captime|--leak-memory|--log-requests-responses|--log-requests-responses-rc-only|--log-requests-responses-rc|--observer-walltime-if-no-runtime|--prepost-log-output|--skip-outstanding-eval-tae|--synchronize-observers|--track-scheduled-runs|--verify-sat|--verify-SAT|--verifySAT|--tae-transform|--tae-transform-valid-values-only|--rf-full-tree-bootstrap|--rf-ignore-conditionality|--rf-impute-mean|--rf-log-model|--log-model|--rf-penalize-imputed-values|--rf-preprocess-marginal|preprocessMarginal|--rf-shuffle-imputed-values|--rf-store-data|--rf-store-data-in-leaves|--rf-subsample-values-when-low-on-memory|--useBrokenVarianceCalculation)
		answers="true  false"
		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
 		return 0
		;;
	*)
		answers="--abort-on-crash --abort-on-first-run-crash --algo --algo-cutoff-length --algo-cutoff-time --algo-deterministic --algo-exec --algo-exec-dir --bound-runs --check-for-unclean-shutdown --check-for-unique-runconfigs --check-for-unique-runconfigs-exception --check-instances-exist --check-result-order-consistent --check-sat-consistency --check-sat-consistency-exception --checkSATConsistency --console-log-level --continous-neighbours --continuous-neighbors --cores --cputime-limit --cputime_limit --cutoff-time --cutoff_length --cutoff_time --deterministic --directories --exception-on-prepost-command --exec-dir --execdir --experiment-dir --feature-file --feature_file --help --help-default-file --help-level --imputation-iterations --instance-dir --instance-file --instance-regex --instance-suffix --instance_file --instance_seed_file --instances --inter-instance-obj --inter-obj --inter_instance_obj --intra-instance-obj --intra-obj --intra_instance_obj --invalid-scenario-reason --iteration-limit --kill-run-exceeding-captime --kill-run-exceeding-captime-factor --kill-runs-on-file-delete --leak-memory --leak-memory-amount --log-level --log-model --log-requests-responses --log-requests-responses-rc --log-requests-responses-rc-only --mask-censored-data-as-kappa-max --mask-inactive-conditional-parameters-as-default-value --max-norun-challenge-limit --num-trees --observer-walltime-delay --observer-walltime-if-no-runtime --observer-walltime-scale --outdir --output-dir --overall-obj --overall_obj --param-file --paramfile --pcs-file --post-scenario-command --post_cmd --pre-scenario-command --pre_cmd --prepost-exec-dir --prepost-log-output --repair --repair-smac-invariant --replace-seeds --restore-args --restore-scenario-arguments --retry-crashed-count --rf-full-tree-bootstrap --rf-ignore-conditionality --rf-impute-mean --rf-log-model --rf-min-variance --rf-num-trees --rf-penalize-imputed-values --rf-preprocess-marginal --rf-ratio-features --rf-shuffle-imputed-values --rf-split-min --rf-store-data --rf-store-data-in-leaves --rf-subsample-memory-percentage --rf-subsample-percentage --rf-subsample-values-when-low-on-memory --run-hashcode-file --run-obj --run-objective --run_obj --runcount-limit --runcount_limit --runtime-limit --scenario-file --search-subspace --search-subspace-file --seed --show-hidden --skip-outstanding-eval-tae --split-min --synchronize-observers --tae --tae-default-file --tae-transform --tae-transform-SAT-quality --tae-transform-SAT-runtime --tae-transform-TIMEOUT-quality --tae-transform-TIMEOUT-runtime --tae-transform-UNSAT-quality --tae-transform-UNSAT-runtime --tae-transform-other-quality --tae-transform-other-runtime --tae-transform-valid-values-only --tae-warn-if-no-response-from-tae --target-run-cputime-limit --target_run_cputime_limit --terminate-on-delete --test-instance-dir --test-instance-file --test-instance-regex --test-instance-suffix --test-instances --test_instance_file --test_instance_seed_file --track-scheduled-runs --track-scheduled-runs-resolution --treat-censored-data-as-uncensored --tuner-timeout --tunertime-limit --up-to-iteration --up-to-tunertime --use-cpu-time-in-tunertime --use-instances --useBrokenVarianceCalculation --verify-SAT --verify-sat --verifySAT --version --wallclock-limit --wallclock_limit "
		if [[ ${cur} == -* ]] ; then
        		COMPREPLY=( $(compgen -W "${answers}" -- ${cur}) )
	        	return 0
    		fi
